      ...
      <div className="flex items-center gap-6">
        ...
        >
          ...
          <div>
            ...
            <span className="ml-2 text-xs px-2 py-0.5 rounded bg-blue-500/10 text-blue-400 font-mono border border-blue-500/20">
              GEO Tracker
            </span>
          </div>
        </button>
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 text-sm bg-surface-900 hover:bg-surface-800 border border-surface-border rounded-lg px-3 py-1.5 transition-colors"
          >
            ...
            <div className="absolute top-full left-0 mt-1.5 w-64 bg-surface-850 border border-surface-border rounded-xl shadow-2xl z-50 p-1.5 space-y-1">
              ...
              <div className="pt-1 border-t border-surface-border">
                <button
                  ...
                  className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs text-blue-400 hover:bg-blue-500/10 font-semibold transition-colors"
                >
        ...
        <button
          ...
          className="text-xs px-2.5 py-1.5 rounded-lg bg-surface-900 hover:bg-surface-800 border border-surface-border text-slate-300 flex items-center gap-1.5 transition-colors"
        >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 text-xs bg-surface-900 hover:bg-surface-800 border border-surface-border rounded-lg px-2.5 py-1.5 transition-colors"
          >
            <Cpu className="w-3.5 h-3.5 text-slate-400" />
            <span className="text-slate-400">Model:</span>
            <span className="text-white font-mono font-medium">{selectedModel}</span>
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="text-white font-mono font-medium">{selectedRounds} {selectedRounds === 1 ? 'Round' : 'Rounds'}</span>
            <ChevronDown className="w-3.5 h-3.5 text-slate-400 ml-0.5" />
          </button>
