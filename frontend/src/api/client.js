 ...
 */
export async function triggerBatchRun(projectId = 4, rounds = 1, model = 'openai/gpt-4o-mini') {
  try {
 ...
 */
export async function generatePromptVariants(projectId = 4, count = 10, model = null) {
  try {
    console.log(`[GEO Prompt Generator] Sending generate request for Project #${projectId} with Model: "${model || 'default'}"`);
    ...
    if (res.ok) {
      const data = await res.json();
      console.log(`[GEO Prompt Generator] Backend returned variants generated by Model: "${data.model || model || 'default'}"`, data);
...
export async function addPromptsBulk(projectId = 4, texts) {
  try {
    const res = await fetch(`${API_BASE}/projects/${projectId}/prompts/bulk`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
  ...
  return texts.map((t, idx) => ({ id: Date.now() + idx, project_id: projectId, text: t, active: true }));
}
...
export const FALLBACK_PROJECTS = [
  { id: 4, brand_name: 'Amul', domain: ['amul.com'], competitors: ['Mother Dairy', 'Britannia', 'Nandini', 'Gowardhan'] },
  { id: 1, brand_name: 'Nike', domain: ['nike.com'], competitors: ['Adidas', 'Puma', 'Reebok'] },
  { id: 2, brand_name: 'boAt', domain: ['boat-lifestyle.com'], competitors: ['Noise', 'JBL', 'Boult'] }
];
...
export const FALLBACK_RUNS = [
  {
    id: 8,
    prompt_id: 1,
    prompt_text: "Which butter brand is best for everyday cooking in India?",
    round: 1,
    status: "done",
    ...
    web_search_results: [
      { url: "https://www.restaurantindia.in/article/top-butter-brands-india.1234", domain: "restaurantindia.in", title: "Top Butter Brands in India: Best Picks for Everyday Cooking", cited: true, score: 0.922 },
      { url: "https://cashkaro.com/blog/best-butter-brands-india", domain: "cashkaro.com", title: "Best Butter Brands in India for Taste and Nutrition Review", cited: true, score: 0.894 },
      { url: "https://www.expertmarketresearch.com/reports/indian-butter-market", domain: "expertmarketresearch.com", title: "Indian Butter Industry Report & Market Share Overview 2026", cited: true, score: 0.865 },
      { url: "https://consumer-voice.org/butter-test-results", domain: "consumer-voice.org", title: "Comparative Test: Table Butter Quality & Purity Analysis", cited: true, score: 0.812 },
    ...
    analysis: {
      ...
      sentiment_reasoning: "Amul is explicitly highlighted as the household staple and top everyday choice.",
      other_brands: ["Mother Dairy", "Britannia", "Gowardhan", "President Butter"]
    }
  },
  {
    id: 9,
    prompt_id: 2,
    prompt_text: "What is the most popular ice cream brand in India right now?",
    round: 1,
    status: "done",
    model: "openai/gpt-4o-mini",
    duration_ms: 21000,
    ...
    web_search_results: [
      { url: "https://brand.education/ice-cream-market-india", domain: "brand.education", title: "Ice Cream Market Share in India 2026", cited: true, score: 0.910 },
      { url: "https://expertmarketresearch.com/ice-cream-report", domain: "expertmarketresearch.com", title: "India Ice Cream Industry Size and Forecast", cited: true, score: 0.880 },
  ...
  },
  {
    id: 10,
    prompt_id: 3,
    prompt_text: "Which Indian dairy brand is most trusted for milk and milk products?",
    round: 1,
    status: "done",
    model: "openai/gpt-4o-mini",
    duration_ms: 24000,
    ...
    web_search_results: [
      { url: "https://tra-research.com/brand-trust-report-india", domain: "tra-research.com", title: "Brand Trust Report 2026: Dairy Sector", cited: true, score: 0.940 },
    ...
    analysis: {
      target_mentioned: true,
      target_sentiment: "positive",
      sentiment_reasoning: "Placed at the very top of dairy trust rankings.",
  ...
  },
  {
    id: 11,
    prompt_id: 4,
    prompt_text: "Best paneer brand available in Indian supermarkets in 2026?",
    round: 1,
    status: "done",
    model: "openai/gpt-4o-mini",
    duration_ms: 28000,
    ...
    web_search_results: [
      { url: "https://mishry.com/best-packaged-paneer-india", domain: "mishry.com", title: "Best Packaged Paneer Brands in India: Reviewed", cited: true, score: 0.890 },
  ...
  },
  {
    id: 12,
    prompt_id: 5,
    prompt_text: "Which cheese brand do professional chefs in India prefer?",
    round: 1,
    status: "done",
    model: "openai/gpt-4o-mini",
    duration_ms: 27000,
...
export const FALLBACK_VARIANTS = [
  {
    ...
    rationale: "Targets consumers looking for clarity on butter variants. Gives Amul an opportunity to appear in both cooking and table butter."
  },
  {
    ...
    rationale: "Directly addresses household breakfast spread habits where Amul dominates market mindshare."
  },
  {
    topic: "Value for Money",
    intent: "Budget Tiers",
    prompt: "Are cooking butters usually cheaper than table butters, and does it really matter for taste?",
    rationale: "Explores price vs quality trade-offs in Indian dairy supermarkets."
  },
  {
    ...
    rationale: "Amul's nationwide cold chain makes it a primary answer to multi-city availability queries."
  },
  {
    ...
    rationale: "Targets trust and purity tests where cooperative dairy brands rank high."
  },
  {
    topic: "Culinary Performance",
    intent: "High Heat",
    prompt: "Can you use salted table butter for tadka, or will it burn too quickly?",
    rationale: "Common culinary concern in Indian kitchens regarding salted butter fat content."
  },
  {
    topic: "Health & Diet",
    intent: "Low Sodium",
    prompt: "What are the healthiest unsalted white butter brands in Indian stores for weight loss?",
    rationale: "Targets health-conscious consumers exploring white butter vs yellow table butter."
  },
  {
    ...
    rationale: "Core marketing battleground between Amul (real dairy) and Kwality Wall's (frozen dessert)."
  },
  {
    topic: "Texture & Quality",
    intent: "Malai Paneer",
    prompt: "Which store-bought packaged paneer stays soft without getting rubbery after frying?",
    rationale: "Paneer texture is the primary review criterion in Indian cooking discussions."
  },
  {
    ...
    rationale: "High-volume consumer query where Amul Pizza Cheese competes with D'lecta."
  }
];
